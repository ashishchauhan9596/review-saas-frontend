      ...
      <div className="login-card">
        ...
        <div className="mb-10 flex items-center justify-center gap-4">
          ...
          <div className="text-left">
            <h1 className="text-base font-bold tracking-[0.1em] text-white/90 uppercase leading-none mb-1">ReviewStack AI</h1>
            <p className="text-[9px] text-gray-500 uppercase tracking-widest leading-none">The Future of Reputation</p>
          </div>
        </div>
