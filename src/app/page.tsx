      ...
      <div className="login-card">
        ...
        <div className="mb-10 flex items-center justify-center gap-4">
          <div className="relative">
            <div className="absolute -inset-6 bg-blue-500/5 rounded-full blur-3xl"></div>
            <img
              src="/logo.png"
              alt="Google Review AI Logo"
              className="relative w-80 h-auto object-contain"
            />
          </div>
          <div className="text-left">
            <h1 className="text-base font-bold tracking-[0.1em] text-white/90 uppercase leading-none mb-1">Google Review AI</h1>
            <p className="text-[9px] text-gray-500 uppercase tracking-widest leading-none">Automated Optimization</p>
          </div>
        </div>
